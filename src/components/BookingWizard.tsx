...
import { Check, ChevronLeft, ChevronRight, Clock, DollarSign } from "lucide-react";
          ...
          {selectedServicio && (
            <div className="bg-[#FFF8F0] p-4 rounded-xl mb-6">
              ...
              <div className="border-t border-gray-200 pt-2 mt-2 flex justify-between text-sm font-bold">
                <span>Total:</span>
                <span className="text-[#C9A96E]">${selectedServicio.precioDesde}</span>
              </div>
              {selectedServicio.depositoPorcentaje > 0 && (
                <div className="flex justify-between text-xs text-gray-400 mt-1">
                  <span>Depósito requerido ({selectedServicio.depositoPorcentaje}%):</span>
                  <span>${Math.round(selectedServicio.precioDesde * selectedServicio.depositoPorcentaje / 100)}</span>
                </div>
              )}
            </div>
          )}
